...
namespace bm176
{
    ...
    void BMLED::paint(juce::Graphics& g)
    {
        ...
        if (!state)
        {
            juce::ColourGradient offGrad(lampOffOuter, cx - R, cy - R, lampOffInner, cx + R, cy + R, false);
